...
export default function SignUpPage() {
    return (
        <div className="w-full h-full flex flex-row">
            ...
            <div className="w-[50%] h-full flex flex-col items-center justify-center bg-linear-to-r from-[#95f66b] via-[#bbe4bb] to-[#f1f5f9]">
                <h1 className="text-5xl font-bold">Welcome to <span className="text-green-500 text-6xl">Saldo flex</span></h1>
