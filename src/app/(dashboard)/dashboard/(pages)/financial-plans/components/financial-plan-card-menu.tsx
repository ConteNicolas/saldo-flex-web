...
export default function FinancialPlanCardMenu({ financialPlan }: FinancialPlanCardMenuProps) {
    const { mutateAsync, isPending: isDeletePending } = useDeleteFinancialPlan();
    const { mutateAsync: updateMutateAsync, isPending: isUpdatePending } = useUpdateFinancialStatusPlan();
